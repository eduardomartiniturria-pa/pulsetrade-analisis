...
function checkHistoryOutcomes(symbol, currentPrice, candles) {
  ...
  state.signalHistory.forEach(h => {
    ...
    // estrategias que definen tp2 (Pivots Breakout & Reversal, EMA Cross Scalping,
    // RSI Divergence, Bollinger Squeeze), la señal quedaba 'pending' esperando tp2
    // indefinidamente si el precio tocaba TP1 y no seguía hasta TP2 — eso generaba
    ...
    // ya no participa en la decisión de cierre ni en el cálculo de rHit/winrate.
